...
<div class="row g-4 mb-4">
    <div class="col-xl-3 col-lg-6 col-md-6">
        <div class="stat-card">
            ...
            <div class="stat-value">{{ $total_project ?? 0 }}</div>
        </div>
    </div>
    <div class="col-xl-3 col-lg-6 col-md-6">
        <div class="stat-card">
...
<div class="row g-4">
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span><i class="bi bi-clock-history me-2"></i>Aktivitas Progress Terbaru</span>
                ...
                <div class="table-container">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr><td colspan="5" class="text-center py-4 text-muted">Belum ada aktivitas progress</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
