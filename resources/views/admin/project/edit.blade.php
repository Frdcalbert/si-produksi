            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('status_project') is-invalid @enderror" 
                        ...
                        <option value="Berjalan" {{ old('status_project', $project->status_project) == 'Berjalan' ? 'selected' : '' }}>Berjalan</option>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control @error('tanggal_project') is-invalid @enderror" 
                           id="tanggal_project" name="tanggal_project" value="{{ old('tanggal_project', date('Y-m-d', strtotime($project->tanggal_project))) }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-control @error('deadline_project') is-invalid @enderror" 
                           id="deadline_project" name="deadline_project" value="{{ old('deadline_project', date('Y-m-d', strtotime($project->deadline_project))) }}" required>
                    @error('deadline_project')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-12">
                    <label for="keterangan" class="form-label">Keterangan</label>
                    <textarea class="form-control @error('keterangan') is-invalid @enderror" 
                              id="keterangan" name="keterangan" rows="3">{{ old('keterangan', $project->keterangan) }}</textarea>
